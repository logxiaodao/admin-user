...
type ApiRepository interface {
	PagingQuery(ctx context.Context, req types.GetApiReq) (rsp types.GetApiRsp, err error)
	FindApiByIdList(ctx context.Context, idList []string) (apiList []types.ApiList, err error)
	AddApi(ctx context.Context, req types.PostApiReq) (err error)
	BatchAddApi(ctx context.Context, req types.BatchPostApiReq) (err error)
	EditApi(ctx context.Context, req types.PutApiReq) (err error)
	DeleteApi(ctx context.Context, req types.DeleteApiReq) (err error)
...
// PagingQuery 分页查询
func (a *apiRepository) PagingQuery(ctx context.Context, req types.GetApiReq) (rsp types.GetApiRsp, err error) {
	// db 实例
...
func (a *apiRepository) FindApiByIdList(ctx context.Context, idList []string) (apiList []types.ApiList, err error) {
	// db 实例
	db := a.db.WithContext(ctx)
...
// AddApi 单条插入
func (a *apiRepository) AddApi(ctx context.Context, req types.PostApiReq) (err error) {
	// db 实例
	db := a.db.WithContext(ctx)
...
// BatchAddApi 批量插入
func (a *apiRepository) BatchAddApi(ctx context.Context, req types.BatchPostApiReq) (err error) {
	// db 实例
	db := a.db.WithContext(ctx)
...
// EditApi 单条修改
func (a *apiRepository) EditApi(ctx context.Context, req types.PutApiReq) (err error) {
	// db 实例
	db := a.db.WithContext(ctx)
...
// DeleteApi 删除 支持批量
func (a *apiRepository) DeleteApi(ctx context.Context, req types.DeleteApiReq) (err error) {
	// db 实例
	db := a.db.WithContext(ctx)
