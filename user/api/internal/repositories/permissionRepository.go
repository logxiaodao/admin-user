...
type PermissionRepository interface {
	PagingQuery(ctx context.Context, req types.GetPermissionReq) (rsp types.GetPermissionRsp, err error)
	FindPermissionByIdList(ctx context.Context, idList []string) (permissionList []types.PermissionList, err error)
	AddPermission(ctx context.Context, req types.PostPermissionReq) (err error)
	EditPermission(ctx context.Context, req types.PutPermissionReq) (err error)
	DeletePermission(ctx context.Context, req types.DeletePermissionReq) (err error)
...
// PagingQuery 分页查询
func (p *permissionRepository) PagingQuery(ctx context.Context, req types.GetPermissionReq) (rsp types.GetPermissionRsp, err error) {
	// db 实例
...
func (p *permissionRepository) FindPermissionByIdList(ctx context.Context, idList []string) (permissionList []types.PermissionList, err error) {
	// db 实例
	db := p.db.WithContext(ctx)
...
// AddPermission 单条插入
func (p *permissionRepository) AddPermission(ctx context.Context, req types.PostPermissionReq) (err error) {
	// db 实例
...
// EditPermission 单条修改
func (p *permissionRepository) EditPermission(ctx context.Context, req types.PutPermissionReq) (err error) {
	// db 实例
	tx := p.db.WithContext(ctx).Begin()
	...
	for _, v := range req.ApiIdList {
		adminPermissionHasApis = append(adminPermissionHasApis, model.AdminPermissionHasAPI{PermissionID: req.Id, APIID: v})
	}
...
func (p *permissionRepository) DeletePermission(ctx context.Context, req types.DeletePermissionReq) (err error) {
	// db 实例
	tx := p.db.WithContext(ctx).Begin()
