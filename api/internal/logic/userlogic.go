...
func NewUserLogic(ctx context.Context, svcCtx *svc2.ServiceContext) UserLogic {
	return UserLogic{
...
func (a *UserLogic) Login(req types2.LoginReq) (*types2.LoginRes, error) {
	...
	if !safe2.MatchPassword(req.Password, userInfo.Password) {
