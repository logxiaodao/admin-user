...
func (p *roleRepository) PagingQuery(ctx context.Context, req types2.GetRoleReq) (rsp types2.GetRoleRsp, err error) {
	...
	err = db.Select(
		...
		"any_value("+adminRole.TableName()+"."+model2.AdminRoleColumns.CreatedAt+") "+model2.AdminRoleColumns.CreatedAt,
		"any_value("+adminRole.TableName()+"."+model2.AdminRoleColumns.UpdatedAt+") "+model2.AdminRoleColumns.UpdatedAt,
